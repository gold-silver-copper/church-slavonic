...
It held the Old Church Slavonic rule engine (declensions, conjugations, Polivanova tables); those rules now live in church-slavonic-core as the OldChurchSlavonic recension.
