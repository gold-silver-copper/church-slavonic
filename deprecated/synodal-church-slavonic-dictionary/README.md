...
It held Synodal senses, lookup and the text analyzer; senses are now _n keys in church-slavonic, and the analyzer lives unmaintained under experiments/analyzer in the repository.
