...
- `ocs.verb.irregular-root` — **partial**: Crosswalk impersonal verbs and attach per-cell facade provenance without collapsing disputed analyses or independent ѥсмь and бꙑти profiles.
...
`ocs.verb.irregular-root`: Crosswalk impersonal verbs and attach per-cell facade provenance without collapsing disputed analyses or independent ѥсмь and бꙑти profiles.
