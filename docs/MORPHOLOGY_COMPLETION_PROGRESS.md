...
- `ocs.numeral` — **implementation-missing**: Resolve the competing asyndetic component-declension account and rare 21–29 ordinal turns, extend ordinal magnitudes beyond 1,000 where licensed, and complete remaining irregular numeral inventories.
...
| `ocs.numeral` | old-church-slavonic | numeral | `implementation-missing` | `PRON-2P-HARD-01`<br>`PRON-2P-SOFT-01`<br>`PRON-2P-J-01`<br>`N-I-F-01`<br>`N-O-N-HARD-01`<br>`N-JA-SOFT-01`<br>`N-A-HARD-01`<br>`N-U-M-01`<br>`NUM-CARD-THREE-01`<br>`NUM-CARD-FOUR-01`<br>`NUM-CARD-TEN-01`<br>`NUM-CARD-TEEN-01`<br>`NUM-CARD-TENS-01`<br>`NUM-CARD-HUNDRED-01`<br>`NUM-CARD-THOUSAND-01`<br>`NUM-CARD-MYRIAD-01`<br>`NUM-CARD-ADDITIVE-01`<br>`NUM-CARD-DISTRIBUTIVE-01`<br>`NUM-ORD-HARD-01`<br>`NUM-ORD-J-01`<br>`NUM-ORD-TEEN-01`<br>`NUM-ORD-DECADE-01`<br>`NUM-ORD-HUNDRED-01`<br>`NUM-ORD-THOUSAND-01`<br>`NUM-ORD-ADDITIVE-01`<br>`NUM-COLL-PRON-01`<br>`NUM-COLL-ADJ-01`<br>`NUM-FRAC-NOUN-01`<br>`OCS-NUMERAL-DERIVED-PENDING` | source-reviewed cardinal grammar through 10,000, structured distributive по + dative grammar through 10,000, simple ordinals first through tenth, base compound ordinals 11–1,000, the inherited collective series two through ten, and the four-identity OCS fractional-noun inventory, with typed agreement/government, complete licensed declension products, correlated multiword analyses, direct/reconstructed/corpus variants, and explicit attested-versus-productive evidence; remaining derived numeral grammar incomplete |
...
`ocs.numeral`: Resolve the competing asyndetic component-declension account and rare 21–29 ordinal turns, extend ordinal magnitudes beyond 1,000 where licensed, and complete remaining irregular numeral inventories.
