...
- `ocs.numeral` — **implementation-missing**: Complete compound ordinals, collective, fractional, distributive, and remaining irregular numeral inventories.
...
| `ocs.numeral` | old-church-slavonic | numeral | `implementation-missing` | `PRON-2P-HARD-01`<br>`PRON-2P-SOFT-01`<br>`N-I-F-01`<br>`N-O-N-HARD-01`<br>`N-JA-SOFT-01`<br>`N-A-HARD-01`<br>`NUM-CARD-THREE-01`<br>`NUM-CARD-FOUR-01`<br>`NUM-CARD-TEN-01`<br>`NUM-CARD-TEEN-01`<br>`NUM-CARD-TENS-01`<br>`NUM-CARD-HUNDRED-01`<br>`NUM-CARD-THOUSAND-01`<br>`NUM-CARD-MYRIAD-01`<br>`NUM-CARD-ADDITIVE-01`<br>`NUM-ORD-HARD-01`<br>`NUM-ORD-J-01`<br>`OCS-NUMERAL-DERIVED-PENDING` | source-reviewed cardinal grammar through 10,000 and simple ordinals first through tenth, with typed agreement/government, full ordinal adjective agreement, correlated multiword analyses, lexical and corpus variants, and explicit attested-versus-productive evidence; remaining derived numeral grammar incomplete |
...
`ocs.numeral`: Complete compound ordinals, collective, fractional, distributive, and remaining irregular numeral inventories.
