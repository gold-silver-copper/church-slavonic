...
The matrix contains **53** required system contracts: **33** have final states and **20** remain non-final. Source discovery has 1 recorded pass and has not converged.

## State totals

| State | Systems |
|---|---:|
| `implementation-missing` | 15 |
| `not-inflectional` | 2 |
| `productive-complete` | 31 |
...
- `ocs.numeral` — **implementation-missing**: Resolve the competing asyndetic component-declension account and rare 21–29 ordinal turns, extend ordinal magnitudes beyond 1,000 where licensed, and complete fractional, distributive, and remaining irregular numeral inventories.
...
| `ocs.numeral` | old-church-slavonic | numeral | `implementation-missing` | `PRON-2P-HARD-01`<br>`PRON-2P-SOFT-01`<br>`PRON-2P-J-01`<br>`N-I-F-01`<br>`N-O-N-HARD-01`<br>`N-JA-SOFT-01`<br>`N-A-HARD-01`<br>`NUM-CARD-THREE-01`<br>`NUM-CARD-FOUR-01`<br>`NUM-CARD-TEN-01`<br>`NUM-CARD-TEEN-01`<br>`NUM-CARD-TENS-01`<br>`NUM-CARD-HUNDRED-01`<br>`NUM-CARD-THOUSAND-01`<br>`NUM-CARD-MYRIAD-01`<br>`NUM-CARD-ADDITIVE-01`<br>`NUM-ORD-HARD-01`<br>`NUM-ORD-J-01`<br>`NUM-ORD-TEEN-01`<br>`NUM-ORD-DECADE-01`<br>`NUM-ORD-HUNDRED-01`<br>`NUM-ORD-THOUSAND-01`<br>`NUM-ORD-ADDITIVE-01`<br>`NUM-COLL-PRON-01`<br>`NUM-COLL-ADJ-01`<br>`OCS-NUMERAL-DERIVED-PENDING` | source-reviewed cardinal grammar through 10,000, simple ordinals first through tenth, base compound ordinals 11–1,000, and the inherited collective series two through ten, with typed agreement/government, full adjective agreement where licensed, correlated multiword analyses, direct/reconstructed/corpus variants, and explicit attested-versus-productive evidence; remaining derived numeral grammar incomplete |
...
The frontier contains **19** source/lineage records. Authority policy: target-recension normative grammars and critical editions; manuscript-grounded dictionaries; independent target texts; manually annotated corpora; explicitly labeled inherited/comparative evidence; automatic, crowd-edited, OCR, and generated evidence only as candidates or evaluation
...
`ocs.numeral`: Resolve the competing asyndetic component-declension account and rare 21–29 ordinal turns, extend ordinal magnitudes beyond 1,000 where licensed, and complete fractional, distributive, and remaining irregular numeral inventories.
