...
- `ocs.numeral` — **implementation-missing**: Complete the source-union ordinal, collective, fractional, distributive, and remaining irregular inventories.
...
`ocs.numeral`: Complete the source-union ordinal, collective, fractional, distributive, and remaining irregular inventories.
