...
- `ocs.numeral` — **implementation-missing**: Complete compound ordinals, fractional, distributive, and remaining irregular numeral inventories.
...
The frontier contains **17** source/lineage records. Authority policy: target-recension normative grammars and critical editions; manuscript-grounded dictionaries; independent target texts; manually annotated corpora; explicitly labeled inherited/comparative evidence; automatic, crowd-edited, OCR, and generated evidence only as candidates or evaluation
...
`ocs.numeral`: Complete compound ordinals, fractional, distributive, and remaining irregular numeral inventories.
