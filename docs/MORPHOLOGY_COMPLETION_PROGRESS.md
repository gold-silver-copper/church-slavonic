...
- `ocs.pronoun.other` — **partial**: Implement typed ni-/ně-/postpositive-particle families including preposition interposition, then allocate the remaining regular class 2/p identities across pronoun, determiner, and numeral systems.
...
`ocs.pronoun.other`: Implement typed ni-/ně-/postpositive-particle families including preposition interposition, then allocate the remaining regular class 2/p identities across pronoun, determiner, and numeral systems.
