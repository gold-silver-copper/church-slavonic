...
| Noun/adjective productive morphology | broad but not language-wide | thirty-six noun contracts exhaust Alypy §§33–44 regular and named irregular families; caller specifications can express arbitrary ordered irregular variants and typed defects; adjective coverage includes short/long positive and full long comparative/superlative declension from independently reviewed stems |
