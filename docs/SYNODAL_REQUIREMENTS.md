...
| Independent registries | complete | 857 lexemes, 3,041 generated exact forms, 857 senses, typed principal parts, reviewed accent witnesses, 159 typed abbreviation cells, family decisions, positional, override, example, rejected-candidate, and reviewed-evidence tables |
