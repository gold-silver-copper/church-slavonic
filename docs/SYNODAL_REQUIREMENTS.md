...
| Independent registries | complete | 910 lexemes, 3,674 generated exact forms, 913 senses, typed principal parts, reviewed accent witnesses, 159 typed abbreviation cells, family decisions, positional, override, example, rejected-candidate, and reviewed-evidence tables |
