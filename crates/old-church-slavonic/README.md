...
| Numerals | `numeral`, `cardinal_numeral_identity`, `compound_cardinal`, `ordinal_numeral`, `ordinal_numeral_paradigm`, typed cardinal paradigms, `Numeral` | Reviewed cardinals through 10,000 and all ten simple ordinal adjective paradigms with typed agreement, government, evidence, and correlated alternatives; exact fallback for other numeral types |
