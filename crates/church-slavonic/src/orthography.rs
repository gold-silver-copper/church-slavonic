...
//! it — 2.0: `ї` is kept as typed and placed by `Form::print`), every
...
/// comparison (see `extractor_legacy::extract::pronoun_attested_matches`).
...
mod tests {
    ...
    fn synodal_realisation_is_the_print_typography() {
        ...
        // The ї is kept as typed: positional ї is Form::print's rule (2.0).
        assert_eq!(realise("бж҃їй", &SYN), "бж҃їй");
    }
