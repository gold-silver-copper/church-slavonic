...
//! paradigms of which part of speech is [`crate::extract`]'s decision.
//!
...
use church_slavonic_core_legacy::grammar::Recension;
use church_slavonic_core_legacy::grammar::{Case, Gender, Number, Person};
