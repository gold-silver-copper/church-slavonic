...
//! [`church_slavonic_core_legacy::orthography::comparison_key`] (manuscript spelling
...
mod harness {
    ...
    fn produce(pos: Pos, key: &str, i: usize, r: &Recension) -> String {
        match pos {
            ...
            Pos::Verb if i >= 549 => {
                let (gender, number) = church_slavonic_core_legacy::schema::l_participle_features(i);
            ...
            Pos::NPron => {
                let (gender, number, case) = church_slavonic_core_legacy::schema::npron_features(i);
