...
; добро̀, and a false analysis is worse than none). Verbatim leaves are
; the recorded frontier: the ве́сь/всѧ́къ npron family (Synodal npron is
; empty — the part-3 intake), the ordinals, бы́ти's future бꙋ́детъ /
; бꙋ́дꙋтъ, enclitic pronouns (ѧ҆̀, є҆го̀, и҆̀хъ, себѣ̀), and titlo
; families not yet admitted (блгⷭ҇вѝ, гл҃ѧ's participle spelling).
(verse 1 9 (s (cap (f и҆)) (v рещѝ :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ":") (f да) (v собра́тисѧ :t pres :p 3 :num sg) (n вода̀ :case nom :num sg) (p ",") (w "ꙗ҆́же") (f под̾) (n не́бо :case ins :num sg) (p ",") (f въ) (w "собра́нїе") (w "є҆ди́но") (p ",") (f и҆) (f да) (v ꙗ҆ви́тисѧ :t pres :p 3 :num sg) (n сꙋ́ша :case nom :num sg) (p ".") (cap (f и҆)) (v бы́ти :t aor :p 3 :num sg) (f та́кѡ) (p ".") (cap (f и҆)) (v собра́тисѧ :t aor :p 3 :num sg) (n вода̀ :case nom :num sg) (p ",") (w "ꙗ҆́же") (f под̾) (n не́бо :case ins :num sg) (p ",") (f въ) (w "собра̑нїѧ") (w "своѧ̑") (p ",") (f и҆) (v ꙗ҆ви́тисѧ :t aor :p 3 :num sg) (n сꙋ́ша :case nom :num sg) (p ".")))
...
(verse 1 11 (s (cap (f и҆)) (v рещѝ :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ":") (f да) (v прорасти́ти :t pres :p 3 :num sg) (n землѧ̀ :case nom :num sg) (w "бы́лїе") (adj травны́й :case acc :num sg :g n) (p ",") (part сѣ́ѧти :t pres :voice act :series long :case acc :num sg :g n) (n сѣ́мѧ :case acc :num sg) (f по) (n ро́дъ :case dat :num sg) (f и҆) (f по) (w "подо́бїю") (p ",") (f и҆) (n дре́во :case acc :num sg) (adj плодови́тый :case acc :num sg :g n) (part твори́ти :t pres :voice act :series long :case acc :num sg :g n) (n пло́дъ :case acc :num sg) (p ",") (w "є҆мꙋ́же") (n сѣ́мѧ :case nom :num sg) (pers :p 3 :num sg :case gen :g n) (f въ) (pers :p 3 :num sg :case loc :g n) (p ",") (f по) (n ро́дъ :case dat :num sg) (f на) (n землѧ̀ :case loc :num sg) (p ".") (cap (f и҆)) (v бы́ти :t aor :p 3 :num sg) (f та́кѡ) (p ".")))
(verse 1 12 (s (cap (f и҆)) (v и҆знестѝ :t aor :p 3 :num sg) (n землѧ̀ :case nom :num sg) (w "бы́лїе") (adj травны́й :case acc :num sg :g n) (p ",") (part сѣ́ѧти :t pres :voice act :series long :case acc :num sg :g n) (n сѣ́мѧ :case acc :num sg) (f по) (n ро́дъ :case dat :num sg) (f и҆) (f по) (w "подо́бїю") (p ",") (f и҆) (n дре́во :case acc :num sg) (adj плодови́тый :case acc :num sg :g n) (part твори́ти :t pres :voice act :series long :case acc :num sg :g n) (n пло́дъ :case acc :num sg) (p ",") (w "є҆мꙋ́же") (n сѣ́мѧ :case nom :num sg) (pers :p 3 :num sg :case gen :g n) (f въ) (pers :p 3 :num sg :case loc :g n) (p ",") (f по) (n ро́дъ :case dat :num sg) (f на) (n землѧ̀ :case loc :num sg) (p ".") (cap (f и҆)) (v ви́дѣти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ",") (f ꙗ҆́кѡ) (n добро̀ :case nom :num sg) (p ".")))
...
(verse 1 17 (s (f и҆) (v положи́ти :t aor :p 3 :num sg) (w "ѧ҆̀") (n бг҃ъ :case nom :num sg) (f на) (n тве́рдь :case loc :num sg) (adj небе́сный :case loc :num sg :g f) (p ",") (f ꙗ҆́кѡ) (v свѣти́ти :t pres :p 3 :num sg :form inf) (f на) (n землѧ̀ :case acc :num sg) (p ",")))
...
(verse 1 21 (s (cap (f и҆)) (v сотвори́ти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (n ки́тъ :case acc :num pl) (w "вели̑кїѧ") (p ",") (f и҆) (w "всѧ́кꙋ") (n дꙋша̀ :case acc :num sg) (adj живо́тенъ :case gen :num pl :g m) (n га́дъ :case acc :num pl) (p ",") (w "ꙗ҆̀же") (v и҆звестѝ :t aor :p 3 :num pl) (w "во́ды") (f по) (n ро́дъ :case dat :num pl) (pers :p 3 :num pl :case gen :g m) (p ",") (f и҆) (w "всѧ́кꙋ") (n пти́ца :case acc :num sg) (adj перна́тъ :case acc :num sg :g f) (f по) (n ро́дъ :case dat :num sg) (p ".") (cap (f и҆)) (v ви́дѣти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ",") (f ꙗ҆́кѡ) (w "дѡбра̀" :amb 6) (p ".")))
(verse 1 22 (s (cap (f и҆)) (w "блгⷭ҇вѝ") (w "ѧ҆̀") (n бг҃ъ :case nom :num sg) (p ",") (w "гл҃ѧ") (p ":") (w "расти́тесѧ") (f и҆) (w "мно́житесѧ") (p ",") (f и҆) (v напо́лнити :t pres :p 2 :num pl :form imp) (w "во́ды") (p ",") (w "ꙗ҆̀же") (f въ) (n мо́ре :case loc :num pl) (p ",") (f и҆) (n пти́ца :case nom :num pl) (f да) (w "ѹ҆мно́жатсѧ") (f на) (n землѧ̀ :case loc :num sg) (p ".")))
...
(verse 1 25 (s (cap (f и҆)) (v сотвори́ти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (w "ѕвѣ̑ри") (n землѧ̀ :case gen :num sg) (f по) (n ро́дъ :case dat :num sg) (p ",") (f и҆) (w "скоты̀") (f по) (n ро́дъ :case dat :num sg) (pers :p 3 :num pl :case gen :g m) (p ",") (f и҆) (w "всѧ̑") (w "га́ды") (n землѧ̀ :case gen :num sg) (f по) (n ро́дъ :case dat :num sg) (pers :p 3 :num pl :case gen :g m) (p ".") (cap (f и҆)) (v ви́дѣти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ",") (f ꙗ҆́кѡ) (w "дѡбра̀" :amb 6) (p ".")))
(verse 1 26 (s (cap (f и҆)) (v рещѝ :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ":") (v сотвори́ти :t pres :p 1 :num pl) (n человѣ́къ :case acc :num sg) (f по) (n ѻ҆́бразъ :case dat :num sg) (w "на́шемꙋ") (f и҆) (f по) (w "подо́бїю") (p ",") (f и҆) (f да) (v ѡ҆блада́ти :t pres :p 3 :num sg) (n ры́ба :case ins :num pl) (adj морскі́й :case ins :num pl :g f) (p ",") (f и҆) (n пти́ца :case ins :num pl) (adj небе́сный :case ins :num pl :g f) (p ",") (p "(") (f и҆) (w "ѕвѣрьмѝ") (p ")") (f и҆) (n ско́тъ :case ins :num pl) (p ",") (f и҆) (w "все́ю") (n землѧ̀ :case ins :num sg) (p ",") (f и҆) (w "всѣ́ми") (n га́дъ :case ins :num pl) (w "пресмыка́ющимисѧ") (f по) (n землѧ̀ :case loc :num sg) (p ".")))
(verse 1 27 (s (cap (f и҆)) (v сотвори́ти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (n человѣ́къ :case acc :num sg) (p ",") (f по) (n ѻ҆́бразъ :case dat :num sg) (w "бж҃їю") (v сотвори́ти :t aor :p 3 :num sg) (pers :p 3 :num sg :case acc :g m) (p ":") (n мꙋ́жъ :case acc :num sg) (f и҆) (n жена̀ :case acc :num sg) (v сотвори́ти :t aor :p 3 :num sg) (w "и҆̀хъ") (p ".")))
(verse 1 28 (s (cap (f и҆)) (w "блгⷭ҇вѝ") (w "и҆̀хъ") (n бг҃ъ :case nom :num sg) (p ",") (w "гл҃ѧ") (p ":") (w "расти́тесѧ") (f и҆) (w "мно́житесѧ") (p ",") (f и҆) (v напо́лнити :t pres :p 2 :num pl :form imp) (n землѧ̀ :case acc :num sg) (p ",") (f и҆) (v госпо́дствовати :t pres :p 2 :num pl :form imp) (w "є҆́ю") (p ",") (f и҆) (v ѡ҆блада́ти :t pres :p 2 :num pl :form imp) (n ры́ба :case ins :num pl) (adj морскі́й :case ins :num pl :g f) (p ",") (p "(") (f и҆) (w "ѕвѣрьмѝ") (p ")") (f и҆) (n пти́ца :case ins :num pl) (adj небе́сный :case ins :num pl :g f) (p ",") (f и҆) (w "всѣ́ми") (n ско́тъ :case ins :num pl) (p ",") (f и҆) (w "все́ю") (n землѧ̀ :case ins :num sg) (p ",") (f и҆) (w "всѣ́ми") (w "га́дами") (w "пресмыка́ющимисѧ") (f по) (n землѧ̀ :case loc :num sg) (p ".")))
(verse 1 29 (s (cap (f и҆)) (v рещѝ :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (p ":") (f сѐ) (p ",") (v да́ти :t aor :p 1 :num sg) (pers :p 2 :num pl :case dat) (w "всѧ́кꙋю") (n трава̀ :case acc :num sg) (w "сѣ́меннꙋю") (part сѣ́ѧти :t pres :voice act :series long :case acc :num sg :g f) (n сѣ́мѧ :case acc :num sg) (p ",") (n є҆́жъ :case voc :num sg) (v бы́ти :t pres :p 3 :num sg) (f верхꙋ̀) (n землѧ̀ :case gen :num sg) (w "всеѧ̀") (p ":") (f и҆) (w "всѧ́кое") (n дре́во :case acc :num sg) (p ",") (n є҆́жъ :case voc :num sg) (v и҆мѣ́ти :t pres :p 3 :num sg) (f въ) (w "себѣ̀") (n пло́дъ :case acc :num sg) (n сѣ́мѧ :case gen :num sg) (w "сѣ́меннагѡ") (p ",") (pers :p 2 :num pl :case dat) (w "бꙋ́детъ") (f въ) (n снѣ́дь :case acc :num sg) (p ":")))
(verse 1 30 (s (f и҆) (w "всѣ̑мъ") (w "ѕвѣрє́мъ") (adj зе́менъ :case dat :num pl :g m) (p ",") (f и҆) (w "всѣ̑мъ") (w "пти́цамъ") (adj небе́сный :case dat :num pl :g f) (p ",") (f и҆) (w "всѧ́комꙋ") (n га́дъ :case dat :num sg) (w "пресмыка́ющемꙋсѧ") (f по) (n землѧ̀ :case loc :num sg) (p ",") (w "и҆́же") (v и҆мѣ́ти :t pres :p 3 :num sg) (f въ) (w "себѣ̀") (n дꙋша̀ :case acc :num sg) (n живо́тъ :case gen :num sg) (p ",") (f и҆) (w "всѧ́кꙋ") (n трава̀ :case acc :num sg) (adj зеле́нъ :case acc :num sg :g f) (f въ) (n снѣ́дь :case acc :num sg) (p ".") (cap (f и҆)) (v бы́ти :t aor :p 3 :num sg) (f та́кѡ) (p ".")))
(verse 1 31 (s (cap (f и҆)) (v ви́дѣти :t aor :p 3 :num sg) (n бг҃ъ :case nom :num sg) (w "всѧ̑") (p ",") (w "є҆ли̑ка") (v сотвори́ти :t aor :p 3 :num sg) (p ":") (f и҆) (f сѐ) (w "дѡбра̀" :amb 6) (w "ѕѣлѡ̀") (p ".") (cap (f и҆)) (v бы́ти :t aor :p 3 :num sg) (n ве́черъ :case nom :num sg) (p ",") (f и҆) (v бы́ти :t aor :p 3 :num sg) (w "ѹ҆́тро") (p ",") (n де́нь :case nom :num sg) (w "шесты́й") (p ".")))
